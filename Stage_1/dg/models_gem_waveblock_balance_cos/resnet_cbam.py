...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        print("Loading the supervised pre-trained model on ImageNet")
        pretrained_net_dict = torch.load('logs/pretrained/RESNET50_CBAM_new_name_wrap.pth', map_location='cpu')
