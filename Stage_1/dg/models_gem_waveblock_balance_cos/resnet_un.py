...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50_un', 'resnet101',
           'resnet152']
...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        ckpt = 'logs/pretrained/resnet50_bar.pth'
        mod = torch.load(ckpt, map_location='cpu')
        mkg = resnet.load_state_dict(mod, strict = False)
        #print("Unloaded:", mkg)
