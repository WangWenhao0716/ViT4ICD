...
class iResNet(nn.Module):
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        print("Loading the supervised Iresnet50 pre-trained model on ImageNet!!!")
        pretrained_net_dict = torch.load('logs/pretrained/iresnet50.pth', map_location='cpu')
        iresnet.load_state_dict(pretrained_net_dict, strict = True)
