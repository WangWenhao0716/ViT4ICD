...
class Train_video(object):

    def __init__(self, root, combine_all=True):
        
        self.images_dir = '' 
        self.img_path = '/raid/VSC/data/train/reference_one_second_cv2_v2/'
    ...
    def preprocess(self):
        ...
        for fpath in fpaths:
            fname = osp.basename(fpath)  # filename: 000001_s10_c01_f000295.jpg #299_1.jpg  #R128807_13.jpg
