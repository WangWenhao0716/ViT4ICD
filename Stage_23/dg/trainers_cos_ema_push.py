...
class Trainer(object):
    ...
    def train(self, epoch, data_loader, data_loader_support_T, data_loader_support_O, optimizer, ema, train_iters=200, print_freq=1):
        self.model.train()
        ...
        for i in range(train_iters):
            ...
            loss_sp = torch.mean(torch.exp(-torch.sum((ori_features_O - ori_features_T)**2, dim=1)))
            
            loss = loss_ce + loss_ce_1 + loss_sp
