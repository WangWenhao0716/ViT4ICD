...
class Trainer(object):
    ...
    def train(self, epoch, data_loader, data_loader_support, data_loader_support_T, data_loader_support_O, optimizer, ema, train_iters=200, print_freq=1):
        self.model.eval()
        ...
        for i in range(train_iters):
            ...
            loss = loss_ce + loss_ce_1 + 100 * loss_sp + 0.2 * loss_gt
