...
from .pvt_v2_sup import pvt_v2_b2
...
class PVT(nn.Module):
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        uni = pvt_v2_b2()
        print("Loading the supervised PVT pre-trained model")
        ckpt = torch.load('./logs/pretrained/pvt_v2_b2.pth', map_location='cpu')
        uni.load_state_dict(ckpt)
