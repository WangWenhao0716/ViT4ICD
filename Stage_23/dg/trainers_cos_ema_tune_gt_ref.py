...
class Trainer(object):
    ...
    def train(self, epoch, data_loader, data_loader_support, data_loader_support_T, data_loader_support_O, idx_to_class, my_dict_q, my_dict_r, optimizer, ema, train_iters=200, print_freq=1):
        self.model.eval()
        ...
        for i in range(train_iters):
            ...
            _1_name = [my_dict_q[idx].split("_")[0] for idx in _1_idx]
            _1_name = np.array(_1_name)
            #print(_1_name)
            
            _2_idx = [idx_to_class[int(class_)] for class_ in _2]
            _2_name = [my_dict_r[idx].split("_")[0] for idx in _2_idx]
            ...
            ori_features_T, _, _ = self.model(support_image_T, targets)
            ori_features_O, _, _ = self.model(support_image_O, targets)
            ...
            loss = loss_ce + loss_ce_1 + 100 * loss_sp + 10 * (loss_gt - loss_ng)
